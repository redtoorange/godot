@rem Build Binaries
call scons platform=windows target=editor accesskit=no module_mono_enabled=yes fast_unsafe=yes d3d12=yes scu_build=yes scu_limit=1024 build_profile="gem_knights_profile.gdbuild"
